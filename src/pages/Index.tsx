...
const Index = () => {
  ...
  const projects = [
    ...
    },
    {
      title: "Code-Forge",
      description:
        "Code-Forge lets teachers create classes, add students, and post extra challenges for practice. Built-in leaderboards, resources, and tracking help keep students motivated.",
      ...
      <NeobrutalistSection className="pt-32 pb-16 bg-background">
        <div className="text-center space-y-8">
          <div className="space-y-4">
            <span className="bg-gradient-to-r from-[#614385] to-[#516395] bg-clip-text text-transparent"></span>
            <p className="text-xl md:text-2xl font-mono max-w-2xl mx-auto">I am a full-stack software engineer</p>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="space-y-4 font-mono text-lg text-white">
              ...
              <p>
                I have been interested in computers as long as I can remember. I daily drive vim and Arch Linux and love
                tinkering.
              </p>
            </div>
          </div>
        ...
        <div className="text-center space-y-12">
          <Card className="max-w-2xl mx-auto bg-white text-background border-brutal neobrutalist-shadow">
            <CardContent className="p-8 space-y-8">
              <p className="text-xl text-black font-mono">Want to connect?</p>
