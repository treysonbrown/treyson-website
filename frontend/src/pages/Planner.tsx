    ...
    <div className="min-h-screen bg-background dark:bg-zinc-950 font-sans selection:text-white transition-colors">
      ...
      <main className="relative z-10 min-h-screen px-3 md:px-6 pt-6 pb-6">
        <div className="w-full max-w-none space-y-4">
          ...
          <SignedOut>
            <div className="bg-card dark:bg-zinc-900 border-4 border-black dark:border-white p-5 md:p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] dark:shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] relative">
